...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/igwn-archive-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15323&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/igwn-archive-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `igwn-archive` can be installed with:

```
conda install igwn-archive
```

It is possible to list all of the versions of `igwn-archive` available on your platform with:
